...
%prep
%setup -q -n String-Random-0.31
cd %{_builddir}
tar xf %{_sourcedir}/libstring-random-perl_0.29-1.debian.tar.xz
cd %{_builddir}/String-Random-0.31
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/String-Random-0.31/deblicense/
...
cp %{_builddir}/String-Random-0.31/LICENSE %{buildroot}/usr/share/package-licenses/perl-String-Random/38e94f89ec602e1a6495ef7c30477d01aeefedc9
if test -f Makefile.PL; then
